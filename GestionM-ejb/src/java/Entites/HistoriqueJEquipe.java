 ...
 */
@Entity
public class HistoriqueJEquipe implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HistoriqueJEquipe)) {
            return false;
        }
        HistoriqueJEquipe other = (HistoriqueJEquipe) object;
    ...
    public String toString() {
        return "Entites.HistoriqueJEquipe[ id=" + id + " ]";
    }
